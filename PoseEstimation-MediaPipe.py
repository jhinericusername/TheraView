...
def upload():
    ...
    if file and file.filename.lower().endswith('.mp4'):
        file.save(os.path.join('uploads','user_input.mp4'))      
    ...
    best_sentence = "Looks like you did really well on your " + best_attribute
    worst_sentence = "Try syncing your " + worst_attribute + " with the video more"

    dict = {
        "score": score,
        "best_attribute":  best_sentence,
        "worst_attribute": worst_sentence,
    }

    json_output = jsonify(dict)
